    ...
    <div id="projects" className="section section-work">
      ...
      <div className="project">
        ...
        <div className="project-description">
          <h3>Credit Karma</h3>
          <p>
            Credit Karma has over 90 million members and 1 billion in revenue
            annually. Recently&nbsp;
            <a
              href="https://techcrunch.com/2020/02/24/intuit-credit-karma/"
              target="_blank"
              rel="noopener noreferrer"
            >
              acquired by Intuit for 7.1b
            </a>
            . It offers free credit score reports, credit cards, personal loans
            shopping, tax filing and other financial products.
          </p>
          <div>
      ...
      <div className="project">
        <a
          className="project-image"
          href="https://www.gleancompany.com/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <picture>
        ...
        <div className="project-description">
          <h3>Glean</h3>
          <p>
            Glean is Smart AP that gives finance teams visibility, clarity, and
            confidence with their vendor spend. Recently&nbsp;
            <a
            ...
            . You can automate accounting workflows and identify savings
            opportunities at the line-item level as well as get the big picture
      ...
      <div className="project">
        <a
          className="project-image"
          href="https://www.solarisbank.com/en/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <picture>
            <source
              srcSet={solarisbankProjectImg}
              type="image/webp"
              alt="solarisBank"
            />
        ...
        <div className="project-description">
          <h3>solarisBank</h3>
          <p>
            solarisBank is a Berlin-based 250-person fintech company which took
            them less than three years to build the banking-as-a-platform, scale
            up a team, and raise almost €100m in funding rounds with Arvato,
            BBVA, Visa, Lakestar and other.
          </p>
          <div>
